...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition = CameraPosition(
      target: LatLng(23.7930298,90.3572027),
      zoom: 17
  );

  late LatLng _initialPosition=LatLng(23.7930298,90.3572027);
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                AppTextField(textController: _addressController, hintText: "Your Address", icon: Icons.location_on),
                SizedBox(height: Dimensions.height20,),
                Padding(
                  padding:  EdgeInsets.only(left: Dimensions.width20),
